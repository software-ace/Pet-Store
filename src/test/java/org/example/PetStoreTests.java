...
public class PetStoreTests {
    ...
    public void verify_selecting_random_animal_category() {
        ...
        Assert.assertTrue(petItemsNumber == 10 || petItemsNumber == 12, "Unexpected number of items: " + petItemsNumber);
    }
    ...
    public void verify_filling_contact_form_and_submit() {
        contactPage.fillForm("Carl", "a@vogf.com", "55292500611", "I want my order wrapped as a gift");
